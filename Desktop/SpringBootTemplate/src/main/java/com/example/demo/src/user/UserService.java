...
public class UserService {
    ...
    public PostUserRes createUser(PostUserReq postUserReq) throws BaseException {
        ...
        try {
            ...
            int left = 1;
            return new PostUserRes(userIdx,jwt,left);
...
//  *********************************************************************
    ...
    //유저 탈퇴(Put)
    public void leftUserEmail(GetUserRes getUserRes) throws BaseException{
        try {
            if(userProvider.checkEmail(getUserRes.getEmail()) == 0){
                throw new BaseException(DATABASE_ERROR);
            }
            int result = userDao.leftUser(getUserRes);
            if(result == 0){
                throw new BaseException(DATABASE_ERROR);
            }
